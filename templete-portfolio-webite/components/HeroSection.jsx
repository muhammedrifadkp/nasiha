        ...
        >
            ...
            <div className="container relative z-10 grid gap-12 lg:grid-cols-12 lg:items-center">
                ...
                <div className="w-full lg:col-span-6 flex justify-center lg:justify-end">
                    <div className="relative group w-full max-w-[480px] sm:max-w-[540px]">
                        ...
                        <div className="relative glass-panel rounded-2xl p-3 shadow-2xl overflow-hidden border border-brand-gold/10">
                            ...
                            <div className="relative aspect-[16/10] w-full rounded-xl overflow-hidden bg-brand-dark">
                                <Image
                                    src="/portfolio_assets/projects/hero_showcase_horizontal.png"
                                    fill
                                    alt="Nasiha Sara - Selected Architecture Showcase"
                            ...
                            <div className="mt-4 p-3 bg-brand-dark/60 rounded-lg border border-brand-gold/5 flex justify-between items-center">
                                <div>
                                    <p className="text-[10px] text-brand-gold font-bold tracking-wider font-sans">FEATURED PROJECT</p>
                                    <p className="text-xs text-brand-light font-medium mt-0.5">Waterfront Modernist Villa</p>
                                </div>
                                <div className="text-right">
                                    <p className="text-[10px] text-brand-gold font-bold tracking-wider font-sans">VISUALIZATION</p>
                                    <p className="text-xs text-brand-light font-medium mt-0.5">3ds Max, Revit & V-Ray</p>
                                </div>
                            </div>
                        </div>
                    </div>
